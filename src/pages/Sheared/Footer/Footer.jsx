        ...
        <div className=" bg-base-200">
            <footer className="footer p-10  text-base-content container mx-auto">
                <div>
                    ...
                    <p>Kids toy Industries Ltd.<br />Providing kids Toys since 2018</p>
                ...
                <div>
                    <span className="footer-title">Needed Link</span>
                    <Link to='/' className="link link-hover">Home</Link>
                    <Link to='/blog' className="link link-hover">Blog</Link>
                    <Link to='/all_toys' className="link link-hover">All Toys</Link>
                    <Link to='/my_toys' className="link link-hover">My Toys</Link>
                    <Link to='/add_a_toys' className="link link-hover">Add A Toy</Link>
                </div>
                <div>
                    ...
                    <span className="footer-title pt-5">address</span>
                    <div className="grid grid-flow-col gap-4">
                        <p className="text-xl">Shop location : <span className="text-sky-400">Notulla Bad,Barishal</span></p>
                    </div>
                </div>
                <div>
